            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Agregar cita</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select">
                                            ...
                                            <option>Limpieza dentales y examenes regulares</option>
                                            <option>Restauraciones dentales</option>
                                            <option>Blanqueamiento dental</option>
                                            <option>Odontopediatria</option>
                                            <option>Cirugia oral y maxilofacial</option>
                                            <option>Ortodoncia y alineacion de sonrrisa</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="display-block">Estado de cita</label>
