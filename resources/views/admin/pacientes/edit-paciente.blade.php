        ...
        <!--<div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="assetsadmin/img/logo.png" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
            ...
            <ul class="nav user-menu float-right">
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
											<span class="avatar">
												<img alt="John Doe" src="assetsadmin/img/user.jpg" class="img-fluid rounded-circle">
											</span>
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="assetsadmin/img/user.jpg" width="40" alt="Admin">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
							<a href="assetsadmin.html"><i class="fa fa-cube"></i> <span>assetsadmin</span></a>
						</li>
						<li>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Alergias<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
